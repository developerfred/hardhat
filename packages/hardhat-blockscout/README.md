...
[Hardhat](https://hardhat.org) plugin for integration with [blockscout](https://blockscout.com/)'s contract verification service.

## What

This plugin helps you verify the source code for your Solidity contracts on [blockscout](https://blockscout.com/).
...
```bash
npm install --save-dev @nomiclabs/hardhat-blockscout
```

And add the following statement to your `hardhat.config.js`:

```js
require("@nomiclabs/hardhat-blockscout");
```

Or, if you are using TypeScript, add this to your `hardhat.config.ts`:

```js
import "@nomiclabs/hardhat-blockscout";
```
